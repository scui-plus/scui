<template>
	<div class="login_bg">
		<div class="login_adv" :style="{backgroundImage: `url(${require('@/assets/images/auth_banner.jpg')})`}">
...
<script>
	...
	export default {
		...
		created: function() {
			...
			console.log('%c SCUI %c Github: https://github.com/scui-plus/scui', 'background:#666;color:#fff;border-radius:3px;', '')
		},
		methods: {
			configDark(){
